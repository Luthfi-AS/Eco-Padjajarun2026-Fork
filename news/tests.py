...
class NewsBlackBoxTests(TestCase):
    ...
    def test_bbnews01_daftar_berita(self):
        ...
        print("\n[BBNEWS01] Input: buka /news/ | Hasil Aktual: Hanya artikel is_published=True tampil | Status: SUKSES")
    ...
    def test_bbnews02_detail_berita_publish(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, self.published_article.title)
        print("\n[BBNEWS02] Input: buka slug valid | Hasil Aktual: Artikel tampil | Status: SUKSES")
    ...
    def test_bbnews03_detail_berita_unpublish(self):
        ...
        print("\n[BBNEWS03] Input: slug is_published=False | Hasil Aktual: 404 | Status: SUKSES")
    ...
    def test_bbnews04_slug_tidak_ada(self):
        ...
        self.assertEqual(response.status_code, 404)
        print("\n[BBNEWS04] Input: slug acak | Hasil Aktual: 404 | Status: SUKSES")
...
class ArticleUnitTests(TestCase):
    def test_ut_art_01_save_slug_kosong(self):
        ...
        print("\n[UT-ART-01] Input: judul 'Eco Run 2026' | Output Aktual: slug = 'eco-run-2026' | Status: SUKSES")
    ...
    def test_ut_art_02_save_slug_sudah_ada(self):
        ...
        print("\n[UT-ART-02] Input: slug manual diisi | Output Aktual: slug manual dipertahankan | Status: SUKSES")
    ...
    def test_ut_art_03_get_absolute_url(self):
        ...
        print(f"\n[UT-ART-03] Input: artikel dengan slug | Output Aktual: URL {expected_url} | Status: SUKSES")
    ...
    def test_ut_art_04_slug_unik(self):
        ...
        print("\n[UT-ART-04] Input: dua judul sama | Output Aktual: IntegrityError (unique) | Status: SUKSES")
    ...
    def test_ut_art_05_default_ordering(self):
        ...
        print("\n[UT-ART-05] Input: beberapa artikel | Output Aktual: urut -created_at (terbaru dulu) | Status: SUKSES")
